...
<body>
	...
	<form action="registrationsuccess" method="post">
		<div class="container">
			<input type="hidden" name="id" value="${user}"> <label
			...
			<label for="eMail"><b>Email</b></label><br> <input type="text"
				...
				required><br> <label for="password"><b>Confirm
			...
			<label for="address"><b>Address</b></label><br> <input
				type="text" placeholder="Enter Address" name="address" required><br>

			<label for="city"><b>City</b></label><br> <input type="text"
				placeholder="Enter City" name="city" required><br> <label
				for="pNumber"><b>Phone Number</b></label><br> <input
				type="text" placeholder="Enter Phone Number" name="phone" required><br>

			<label for="charityPref"><b>Preferred Charity</b></label><br> <input
				type="text" placeholder="Enter a Charity Name" name="charityPref"
				required><br>
